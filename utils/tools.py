import torch
from models.Resnet.Resnet_bin import ResNet18
...
if __name__ == "__main__":
    ...
    layers  = flat_net(model, (nn.BatchNorm2d, nn.BatchNorm1d, nn.Linear, nn.Conv2d, QLayer))
    a = [object.__repr__(layer).split(" ")[-1] for layer in layers]