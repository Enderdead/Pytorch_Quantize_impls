...
import torchvision
def get_mnist(batch_size=200, valid_ratio=0.2, directory="/tmp/MNIST", transform_both=None, transform_train=None, transform_valid=None):
    ...
    valid_set = torch.utils.data.DataLoader(valid_dataset,batch_size=batch_size, shuffle=True)    
